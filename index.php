...
// !Creates an instance of the controller to execute a custom statement
            ...
            <div class="tab-pane fade show active" id="nav_form_persona" role="tabpanel" aria-labelledby="nav_form_persona_tab">
                <div class="container">
                    ...
                    <form class="form" id="form_Persona" novalidate>
                        ...
                        <button class="btn btn-primary" role="navigation" id="nextTabP">Siguiente</button>
                    </form>
                </div>
            </div>
                    ...
                    <form class="form" id="form_Empresa" novalidate>
                        ...
                        <div class="row gap-3 justify-content-md-center">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="form_Empresa_Colonia" name="form_Empresa_Colonia" required>
                                <div class="invalid-feedback">
                                    Ingrese una colonia.
                                </div>
                                <div class="valid-feedback">
                        ...
                        <button class="btn btn-primary" role="navigation" id="previusTabE">Anterior</button>
                        <button class="btn btn-primary" role="navigation" id="nextTabE">Siguiente</button>
                    </form>
                </div>
            </div>
            <div class="tab-pane fade" id="nav_form_documentos" role="tabpanel" aria-labelledby="nav_form_documentos_tab">
                <div class="container">
                    ...
                    <form class="form" id="form_Documentos" novalidate enctype="multipart/form-data">
                        ...
                        <button class="btn btn-primary" role="navigation" id="previusTabD">Anterior</button>
                        <button class="btn btn-primary" role="navigation" id="nextTabD">Siguiente</button>
                    </form>
                </div>
            </div>
